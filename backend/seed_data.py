...
async def create_seed_data():
    ...
    agencies_data = [
        {'name': 'وكالة صنهاجة الرباط', 'city': 'الرباط', 'address': 'شارع محمد الخامس، الرباط', 'phone': '+212537123456'},
        {'name': 'وكالة صنهاجة الدار البيضاء', 'city': 'الدار البيضاء', 'address': 'شارع الحسن الثاني، الدار البيضاء', 'phone': '+212522789012'},
        {'name': 'وكالة صنهاجة فاس', 'city': 'فاس', 'address': 'شارع علال الفاسي، فاس', 'phone': '+212535345678'},
        {'name': 'وكالة صنهاجة مراكش', 'city': 'مراكش', 'address': 'شارع محمد السادس، مراكش', 'phone': '+212524901234'},
        {'name': 'وكالة صنهاجة طنجة', 'city': 'طنجة', 'address': 'شارع الاستقلال، طنجة', 'phone': '+212539567890'},
        {'name': 'وكالة صنهاجة أكادير', 'city': 'أكادير', 'address': 'شارع الأمير مولاي عبدالله، أكادير', 'phone': '+212528234567'}
    ]
